...
define_spacial_numeric!(Unsigned, u32, (As(i32), As(i64), As(f32)));
define_spacial_numeric!(Signed, i32, (As(u32), As(f32)));
define_spacial_numeric!(Unsigned, u64, (As(u32), As(f32)));
define_spacial_numeric!(Signed, i64, (As(u32), As(f32)));
